...
public class DecimalTextFormatter extends TextFormatter<Number> {
    ...
    private static UnaryOperator<javafx.scene.control.TextFormatter.Change> getUnaryOperator(int maxDecimals, boolean allowsNegative, int noOfDigitsBeforeDecimal) {
